  ...
  <div class="registration-form">
    <form @submit.prevent="handleSubmit" class="form">
      ...
      <div class="form-group">
        ...
        <p v-if="showErrors.primerNombre" class="text-danger error-message">{{ errors.primerNombre }}</p>
      </div>
      <!-- Campo para el segundo nombre -->
      <div class="form-group">
        <label for="segundoNombre" class="form-label">Segundo Nombre</label>
        <input type="text" id="segundoNombre" v-model="driver.segundoNombre" class="form-control">
        <p v-if="showErrors.segundoNombre" class="text-danger error-message">{{ errors.segundoNombre }}</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p v-if="showErrors.apellidoPaterno" class="text-danger error-message">{{ errors.apellidoPaterno }}</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p v-if="showErrors.apellidoMaterno" class="text-danger error-message">{{ errors.apellidoMaterno }}</p>
      </div>
      <!-- Campo para el DNI -->
      <div class="form-group">
        <label for="dni" class="form-label">DNI</label>
        <input type="text" id="dni" v-model="driver.dni" class="form-control">
        <p v-if="showErrors.dni" class="text-danger error-message">{{ errors.dni }}</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p v-if="showErrors.licenciaConducir" class="text-danger error-message">{{ errors.licenciaConducir }}</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p v-if="showErrors.categoriaLicencia" class="text-danger error-message">{{ errors.categoriaLicencia }}</p>
      </div>
      ...
      <div class="form-group">
        ...
        <p v-if="showErrors.fechaVencimientoLicencia" class="text-danger error-message">{{ errors.fechaVencimientoLicencia }}</p>
        <p v-if="showErrors.dateError" class="text-danger error-message">{{ dateErrorMessage }}</p>
      </div>
      <!-- Campo para el teléfono -->
      <div class="form-group">
        <label for="telefono" class="form-label">Teléfono</label>
        <input type="text" id="telefono" v-model="driver.telefono" class="form-control">
        <p v-if="showErrors.telefono" class="text-danger error-message">{{ errors.telefono }}</p>
      </div>
...
<script src="../../js/RegistrarView/DriverFormSc.js"></script>

<style scoped src="../../assets/styles/St_RegistrarView/DriverFormSt.css"></style>
